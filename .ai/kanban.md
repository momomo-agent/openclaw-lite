...
| F277 ACP 协议层 | ✅ 完成 | core/acp-client.js + SDK 0.16.1，commit a9a1fbb |
| F278 白名单机制 | ✅ 完成 | WHITELIST 只含 Claude Code，其他移除 |
| F279 Gemini CLI ACP | ✅ 完成 | 协议层验证通过，需 GEMINI_API_KEY 做 E2E |
| F280 Codex ACP | ⏸️ 搁置 | Codex 只有 MCP server 不支持 ACP，等 Codex 更新 |
| ~~bug~~ Claude Code --verbose | ✅ 修复 | stream-json 需要 --verbose，commit 4d2ac13 |
